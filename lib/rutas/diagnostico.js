...
const { estadoDeLlaves } = require('../sesion');
...
module.exports = publico(async (req, res) => {
  const revision = {
    ...
    ambiente: AMBIENTE,
    // Qué llaves compartidas hay, sin decir cuáles son. En la app del club
    // tiene que decir siempre "apagadas".
    llaves: estadoDeLlaves(),
