...
const { VERSION, AMBIENTE, ANOTACION } = require('../version');
...
const TABLAS_QUE_USA_EL_CODIGO = [
  ...
  'grupo_caballada', 'grupo_miembro',
  'convocatoria', 'anotacion',
...
module.exports = publico(async (req, res) => {
  const revision = {
    ...
    llave: estadoDeLlave(),
    // Si la solapa Anotación está a la vista en esta copia.
    anotacion: ANOTACION ? 'prendida' : 'apagada',
